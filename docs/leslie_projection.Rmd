...
# The line below creates a vector of nine values from 0 to 8
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below creates an empty matrix of four by four
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below fills in first row of matrix w/ initial starting pop
proj_year[1, ] <- fish_year0

# The for loop below uses dot product 
